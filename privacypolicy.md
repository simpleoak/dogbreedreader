...
SimpleOak built the Dog Breed Reader app as an ad-supported app. This SERVICE is provided by SimpleOak and is intended for use as is.
...
For a better experience while using our Service, we may require you to provide us with certain personally identifiable information, including but not limited to pictures from the camera. The information that we request is retained on your device and is not collected by us in any way.
